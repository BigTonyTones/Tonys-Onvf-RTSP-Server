...
echo "============================================================"
echo "Tonys Onvif-RTSP Server v5.5.1 - Ubuntu Development Setup"
echo "============================================================"
...
if ! python3 -c "import flask" &> /dev/null; then
    echo "  Missing core Python packages: flask, flask-cors, requests, pyyaml, psutil"
...
echo ""
echo "============================================================"
echo "Starting Tonys Onvif Server v5.5.1..."
echo "============================================================"
