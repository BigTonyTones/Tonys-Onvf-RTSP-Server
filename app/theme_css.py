...
_THEMES = {
    ...
    'protect-dark':  ('#101214', '#1b1e21', '#1b1e21', '#f9fafa', '#aeb4ba', '#697077', '#006fff', '#2284ff', '#38cc65', '#f0383b', '#2c3035', '#26292c'),
    'protect-light': ('#f6f7f9', '#ffffff', '#ffffff', '#212327', '#50565e', '#858b93', '#006fff', '#005ad1', '#38cc65', '#f0383b', '#e2e5e9', '#f6f7f9'),
}
